...
spotify_token <- get_spotify_access_token( client_id = id, client_secret = secret)
save(spotify_token, file = "spotify_token")
...
morrison <- fromJSON("http://api.nytimes.com/svc/search/v2/articlesearch.json?q=toni+morrison&api-key=YOUR_API_KEY_HERE", flatten = TRUE) %>% data.frame()
